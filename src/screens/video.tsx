...
import VideoPlayer, { VideoPlayerRef } from '../../reanimated-player';
...
export const VideoScreen = ({
  ...
  const renderOptionsBackdrop = useCallback((props: BottomSheetBackdropProps) => {
    return (
      <BottomSheetBackdrop
        disappearsOnIndex={-1}
        appearsOnIndex={0}
        ...
        <GestureDetector gesture={panGesture}>
          <Animated.View style={getVideoContainerStyle}>
            ...
            <VideoPlayer
              ...
              onTapBack={foldVideo}
              paused={paused}
              onPausedChange={(state: boolean) => {
                dispatch(setPlayerPaused(state));
              }}
              onTapPause={(state: boolean) => {
